...
Route::group(['prefix' => 'web-v3', 'as' => 'web-v3'], function () {
    ...
    Route::get('inspection_photo_tags', function () {
        return view('admin.inspection_photo_tags');
    });
    Route::get('required_photo_tags', function () {
        return view('admin.required_photo_tags');
    });
    ...
    Route::get('auth_signup', function () {
        return view('admin.auth.signup');
    });

    Route::get('auth_forgot_pass', function () {
...
//Route::get('signup/{plan?}', 'HomeController@registerView')->name("signupPage");
//Route::post('register/{plan?}', 'HomeController@register');

Route::post('password/reset/{token}', 'UserController@changePasswordWeb')->name("customPasswordReset");
Auth::routes();

//Route::get('login', 'UserController@loginView')->name("loginPage")->middleware('guest');
...
Route::post('user/forgot/password', 'UserController@forgotPassword')->name("resetPassword");
...
//        return view("admin.user_type");
    ...
    Route::group(['middleware' => [/*'subscription.auth'*/]], function() {
        ...
        Route::get('user-type', 'CompanyGroupController@index')->name("userTypeListing");
        Route::get('user-type_datatable', 'CompanyGroupController@companyGroupDatatable')->name("userTypeDatatable");
        Route::post('user-type/store', 'CompanyGroupController@store')->name('addUserType');
        Route::post('user-type/delete/{id}', 'CompanyGroupController@delete')->name('deleteUserType');
        Route::get('user-type/editFormDetails/{id}', 'CompanyGroupController@edit')->name('getUserTypeDetails');
        Route::post('user-type/update/{id}', 'CompanyGroupController@update')->name('updateUserType');


        Route::get('inspect_user', 'UserController@inspectorUserList')->name("userListing");
        Route::get('inspect_user_datatable', 'UserController@inspectorUserDatatable')->name("userDatatable");
        Route::post('inspect_user/store', 'UserController@storeInspector')->name('addUser');
        Route::post('inspect_user/delete/{id}', 'UserController@deleteInspector')->name('deleteUser');
        Route::get('inspect_user/editFormDetails/{id}', 'UserController@edit')->name('getUserDetails');
        Route::post('inspect_user/update/{id}', 'UserController@updateInspector')->name('updateUser');
