...
//        $param_rules['tags']  = "required|json";
        ...
        $update = $request->only(['target_type', 'target_id']);
        ...
        if ($request->hasFile('image_url')) {
            ...
            if ($projectMedia->exists) {
                $imageName = pathinfo($projectMedia['path'], PATHINFO_FILENAME);
        ...
        if ($request['target_type'] !== 'query') {
            ...
            $param = $request->all();
            $param['image_path'] = $projectMedia->path;
            ...
            ProjectMedia::addImageText_3($param);
        }
