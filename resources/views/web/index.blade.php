        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <nav>
                <ul class="d-flex align-items-center">
                    ...
                    <li>
                        <a href="{{route("login")}}" class="btn-theme auth-btn">Login</a>
                    </li>
                </ul>
            </nav>
        </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="work-card">
                        ...
                        <div class="work-body">
                            <h2>Sign Up</h2>
                            <p>
                                Create your account and Buy <br />
                                subscription to start your journey <br />
                                with Field scope
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="work-card">
                        ...
                        <div class="work-body">
                            <h2>Create Team</h2>
                            <p>
                                Add your inspectors to assign <br />
                                projects and view their created <br />
                                projects.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="work-card">
                        ...
                        <div class="work-body">
                            ...
                            <p>
                                Use the app to perform inspections <br />
                                efficiently, with the ability to capture <br />media data
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="work-card">
                        ...
                        <div class="work-body">
                            ...
                            <p>
                                Instantly generate professional,<br />
                                detailed reports with the click of <br />
                                a button.
                            </p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-6">
                ...
                <p class="mt-4">
                    Revolutionize your inspection processes with FieldScope. Sign up
                    <br />
                    <span class="d-block mt-2"
                    >now to experience the future of mobile inspection
								technology.</span
                    >
                </p>
